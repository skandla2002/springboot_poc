...
public class OAuthAttributes {
    ...
    private static OAuthAttributes ofNaver(String userNameAttirbuteName, Map<String, Object> attributes) {
        ...
        return OAuthAttributes.builder()
                ...
                .attributes(response)
                .nameAttirbuteKey(userNameAttirbuteName)
                .build();
    }
