...
public class PostsRepositoryTest {
    ...
    @After // Junit에서 단위 테스트 끝날때 마다 수행되는 메소드(배포전 전체 테스트 수행시 테스트간 데이터 침범 막음)
    public void cleanup(){
       postsRepository.deleteAll();
    }

    // 쿼리 보기 옵션: application.properties내 설정: 
    ...
    // => H2문법이므로 MySql 문법으로 변환하기 위해서는 properties내 파일 추가 수정 필요
    @Test
    public  void 게시글저장_불러오기() {
        ...
        postsRepository.save(Posts.builder() // 테이블 posts에 insert/update 쿼리를 실행함
